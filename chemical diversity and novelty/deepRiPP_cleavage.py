...
def get_info(fa_file):
    """
    Parse a FASTA file and predict cleavage sites for sequences.

    Args:
        fa_file (str): Path to the FASTA file.

    Returns:
        list: Cleavage predictions.
    """
    aa_list = []
...
def check_ripp(class_p):
    """
    Process cleavage predictions and format them into a DataFrame.

    Args:
        class_p (list): List of cleavage predictions.

    Returns:
        pandas.DataFrame: DataFrame containing processed predictions.
    """
    ref = {}
    _sequence = []
    start = []
